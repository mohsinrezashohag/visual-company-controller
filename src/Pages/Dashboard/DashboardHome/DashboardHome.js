                        ...
                        <div className="side-links">
                            ...
                            {cto &&
                                ...
                                <div>
                                    ...
                                    <NavLink className="nav-link page-link" to='/dashboard/blogsOrNotice'>Write Blogs</NavLink>
                                    <NavLink className="nav-link page-link" to='/dashboard/blogs'>Blogs</NavLink>
